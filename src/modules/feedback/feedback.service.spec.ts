...
describe('FeedbackService', () => {
    ...
    const mockNotificationService = {
        createFeedbackStatusChange: jest.fn(),
    };
    ...
    describe('findAll', () => {
        it('should return paginated feedback with default parameters', async () => {
            const mockFeedbackItems = [
                {
                    id: '0cd99ac2-8665-497f-b0de-45b9e9744491',
                    content: 'Test feedback 1',
                    category: FeedbackCategory.FEATURE
                },
                {
                    id: '0cd99ac2-8665-497f-b0de-45b9e9744492',
                    content: 'Test feedback 2',
                    category: FeedbackCategory.BUG
                },
                {
                    id: '0cd99ac2-8665-497f-b0de-45b9e9744493',
                    content: 'Test feedback 2',
    ...
    describe('update', () => {
        it('should update feedback status successfully', async () => {
            const feedbackID = '0cd99ac2-8665-497f-b0de-45b9e9744493'
            const userID = 'c484aba5-569e-443c-a561-c70d93ddbea1'
            ...
            // Act
            const result = await service.update(updateFeedbackInput);
            ...
            expect(mockNotificationService.createFeedbackStatusChange).toHaveBeenCalledWith(
                userID,
                updateFeedbackInput.status
            );
        });
        ...
        it('should throw error when feedback not found', async () => {
            ...
            // Act & Assert
            await expect(service.update({id: feedbackID, status: FeedbackStatus.REVIEWED}))
